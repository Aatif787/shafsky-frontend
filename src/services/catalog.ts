...
export const OFFICIAL_SHAFSKY_CATEGORIES: CategoryCatalogItem[] = [
  {
    ...
    shortName: "All",
    icon: Sparkles,
    description: "Explore all official Shafsky Aviation concierge & travel assistance services.",
    sortOrder: 0,
    isActive: true,
  },
  {
...
export const OFFICIAL_SHAFSKY_SERVICES: ServiceCatalogItem[] = [
  ...
  {
    id: "silver",
    slug: "silver-escort-package",
    name: "Silver Escort Package",
    categoryId: "airport_assistance",
    categoryName: "Airport Assistance",
    bookingServiceId: "silver",
    icon: Users,
    oneLiner: "Standard aerobridge escort and dedicated luggage porter assistance.",
    estTime: "30 sec booking",
    startingPrice: "Starting ₹4,500",
    badge: "Standard Escort",
    overview:
      "A dedicated personal host meets you upon exit with a personalized name placard, managing your luggage with a dedicated porter and guiding you through security and immigration queues.",
    includedFeatures: [
      "Aerobridge welcome with personalized name placard",
      "Dedicated porter for checked & hand luggage",
      "Fast-track security & immigration guidance",
      "Seamless transfer to curbside vehicle",
    ],
    whoIsThisFor: "Individuals, business travelers, and families needing smooth airport guidance.",
    requirements: ["Airport Code", "Travel Date", "Passenger Count"],
    imageUrl: meetGreetImg,
    videoUrl: meetVideo,
    sortOrder: 1,
    isActive: true,
    isHidden: false,
  ...
  {
    id: "gold",
    slug: "gold-vip-sanctuary-package",
    name: "Gold VIP Sanctuary Package",
    categoryId: "airport_assistance",
    categoryName: "Airport Assistance",
    bookingServiceId: "gold",
    icon: Crown,
    oneLiner: "Aerobridge escort, VIP lounge sanctuary access, fast-track & porter service.",
    estTime: "1 min booking",
    startingPrice: "Starting ₹8,500",
    badge: "Most Popular",
    overview:
      "Complete VIP airport concierge experience combining aerobridge host greeting, dedicated baggage porterage, priority diplomatic passport control, and relaxing VIP lounge access with gourmet buffet.",
    includedFeatures: [
      "Aerobridge greeting with personalized placard",
      "Dedicated baggage porterage",
      "Diplomatic fast-track passport control",
      "VIP Lounge Sanctuary access with gourmet dining",
      "Electric airside buggy transport across gate concourse",
    ],
    whoIsThisFor: "Frequent flyers, VIP executives, families, and comfort seekers.",
    requirements: ["Airport Code", "Flight Number", "Travel Date"],
    imageUrl: lounge,
    sortOrder: 2,
    isActive: true,
    isHidden: false,
  ...
  {
    id: "elite",
    slug: "elite-presidential-package",
    name: "Elite Presidential Package",
    categoryId: "airport_assistance",
    categoryName: "Airport Assistance",
    bookingServiceId: "elite",
    icon: Sparkles,
    oneLiner: "Private VIP terminal suite, tarmac Maybach transfer & dedicated protocol officer.",
    estTime: "1 min booking",
    startingPrice: "Starting ₹18,500",
    badge: "VVIP Presidential",
    overview:
      "The pinnacle of VVIP luxury travel: private VIP terminal suite access, personal diplomatic protocol officer, private Maybach tarmac sedan transfer directly to aircraft steps, and in-suite customs clearance.",
    includedFeatures: [
      "Al Majlis / Encalm Privé Private VIP Terminal Suite",
      "Private Maybach tarmac limousine transfer",
      "Personal diplomatic protocol officer & butler",
      "In-suite passport control & customs processing",
      "Unlimited baggage porterage & flight delay monitoring",
    ],
    whoIsThisFor: "Diplomats, celebrities, corporate C-suite executives, and VVIP delegations.",
    requirements: ["Airport Code", "Flight Details", "Travel Date"],
  ...
  try {
    ...
    if (json && json.success && Array.isArray(json.data) && json.data.length > 0) {
      ...
      return json.data.map((item: any, idx: number) => ({
        ...
        categoryName: item.category || item.categoryName || "Airport Assistance",
        bookingServiceId: item.booking_service_id || item.bookingServiceId || "meet_greet",
        icon: Users,
        oneLiner: item.one_liner || item.description || "Official Shafsky Aviation Service",
        ...
        overview: item.description || "Official Shafsky Aviation Service.",
