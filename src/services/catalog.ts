...
export const OFFICIAL_SHAFSKY_SERVICES: ServiceCatalogItem[] = [
  // ── 1. AIRPORT ASSISTANCE ──
  {
    ...
    icon: Users,
    oneLiner: "Personal host welcoming you inside the airport and escorting you to your gate or ride.",
    ...
    includedFeatures: [
      ...
      "Priority fast-track through security & immigration",
      "Seamless transfer to lounge, gate, or luxury vehicle",
    ],
  ...
  },
  {
    ...
    includedFeatures: [
      ...
      "Expedited passport control processing",
      "Dedicated airport security screening lane",
      "Fast-track assistance for arrivals & departures",
    ],
    whoIsThisFor: "Busy travelers, tight connections, and frequent flyers.",
  ...
  },
  {
    ...
    icon: Hotel,
    oneLiner: "Relax in quiet private suites with hot buffets, beverages, and fast Wi-Fi.",
    estTime: "1 min booking",
    ...
    includedFeatures: [
      "Unlimited gourmet food buffet & beverages",
      "Private rest zones & quiet workspaces",
      "High-speed Wi-Fi & device charging stations",
      "Clean shower suites & luxury amenities",
    ],
    whoIsThisFor: "Transit passengers, remote executives, and comfort seekers.",
  ...
  },
  {
    ...
    includedFeatures: [
      "Dedicated mobility assistant from vehicle drop-off to seat",
      "Seamless elevator and gate access",
      "Ambulift and ramp assistance for stairless boarding",
      "Priority boarding support",
    ],
    whoIsThisFor: "Senior citizens, injured travelers, and mobility-assisted guests.",
    requirements: ["Mobility Details", "Flight Number", "Travel Date"],
    imageUrl: medicalAssistImg,
    sortOrder: 4,
    isActive: true,
    isHidden: false,
  },
  {
    ...
    includedFeatures: [
      "Curbside drop-off greeting and baggage unloading",
      "Heavy luggage loading & trolley transport",
      "Escort directly to check-in counters",
      "Safe handling for fragile items",
    ],
    whoIsThisFor: "Travelers with heavy luggage, families with strollers, and group tours.",
    requirements: ["Bag Count", "Curbside Drop-off Time"],
    imageUrl: cargoAssistImg,
    sortOrder: 5,
    isActive: true,
    isHidden: false,
  },
  {
    ...
    includedFeatures: [
      "Carousel monitoring & baggage tag verification",
      "Immediate luggage retrieval off belt",
      "Escort through customs inspection",
      "Loading directly into waiting destination ride",
    ],
    whoIsThisFor: "Arriving passengers with multiple bags or sports gear.",
