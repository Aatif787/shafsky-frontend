...
export const Route = createFileRoute("/solutions/aviation")({
  head: () => ({
    meta: [
      { title: "Private Jet Charter & Private Aviation — Shafsky Aviation" },
      {
        name: "description",
        content:
          "On-demand private jet charter, VIP FBO terminal access, custom flight schedules, and bespoke private cabin luxury.",
      },
    ],
  }),
