  ...
  head: () => ({
    meta: [
      { title: "Private Jet Charter & VIP Aviation — Shafsky Aviation Services" },
      {
        name: "description",
        content:
          "Experience the pinnacle of private aviation. On-demand private jet charter, FBO terminal suites, and custom flight itineraries across India and worldwide.",
      },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Private Jet Charter & VIP Aviation — Shafsky Aviation Services" },
      { property: "og:description", content: "On-demand private jet charter, FBO terminal suites, and custom flight itineraries." },
      { property: "og:url", content: `${BUSINESS.BASE_URL}/charter` },
      { property: "og:type", content: "website" },
      { property: "og:image", content: `${BUSINESS.BASE_URL}/og-image.jpg` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Private Jet Charter & VIP Aviation — Shafsky Aviation Services" },
      { name: "twitter:description", content: "On-demand private jet charter, FBO terminal suites, and custom flight itineraries." },
      { name: "twitter:image", content: `${BUSINESS.BASE_URL}/og-image.jpg` },
    ],
    links: [{ rel: "canonical", href: `${BUSINESS.BASE_URL}/charter` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: `${BUSINESS.BASE_URL}/charter`,
          description: "On-demand private jet charter, FBO terminal suites, and custom flight itineraries across India and worldwide.",
          areaServed: "IN",
        }),
      },
    ],
