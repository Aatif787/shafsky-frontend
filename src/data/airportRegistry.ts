...
export const AIRPORT_REGISTRY: Record<string, AirportRegistryEntry> = {
  ...
  ATQ: {
    ...
    shortDescription: "Gateway to the Golden Temple city. Enjoy dedicated airside assist, luggage assistance, and executive transfers.",
    ...
    seo: {
      ...
      description: "Book VIP Meet & Greet and luxury transfers at Sri Guru Ram Dass Jee International Airport (ATQ).",
