...
import { ArrowRight, Plane, Search, CheckCircle2, AlertCircle, Sparkles, RefreshCw, UserCheck, ShieldCheck, ShoppingBag } from "lucide-react";
...
export function AirportWorkflow({ searchParams }: AirportWorkflowProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`grid grid-cols-1 ${currentStep > 1 && currentStep < 6 ? "lg:grid-cols-12" : ""} gap-8 items-start`}>
        {/* Main Workflow Form Card */}
        <div className={currentStep > 1 && currentStep < 6 ? "lg:col-span-8" : "w-full"}>
          <AnimatePresence mode="wait">
            ...
            >
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-slate-100 flex justify-end">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-amber-600 via-amber-700 to-amber-800 text-white font-mono text-xs font-extrabold uppercase tracking-widest shadow-md hover:scale-105 transition-all disabled:opacity-50 cursor-pointer"
                    >
                      {busy ? (
                        <>
              ...
              {/* STEP 3: DISPLAY AVAILABLE AIRPORT SERVICES & PACKAGES */}
              {currentStep === 3 && (
                <div className="space-y-6">
                  <div className="border-b border-slate-100 pb-4">
                    <span className="text-[10px] font-mono text-amber-800 font-bold uppercase tracking-widest px-3 py-1 rounded-full bg-amber-50 border border-amber-200">
              ...
              {currentStep === 5 && (
                <div className="space-y-6">
                  ...
                  <ReviewSummary
                    ...
                    items={[
                      { label: "Validated Flight", value: `${state.flightNumber || "Direct Reservation"} (${state.direction.toUpperCase()})` },
