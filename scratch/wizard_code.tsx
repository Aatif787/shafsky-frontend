        ...
        {isFlightValidated && (
          <>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              ...
              <div className="rounded-2xl panel-luxury p-6 shadow-luxury-md">
                ...
                <div className="grid gap-3.5 sm:grid-cols-2">
                        ...
                        <PopoverContent className="w-56 p-2 max-h-60 overflow-y-auto bg-white border rounded-xl shadow-lg z-50">
                          {COUNTRIES.map((c) => (
                            <button
                              ...
                              className="w-full text-left px-3 py-1.5 text-xs hover:bg-black/5 rounded transition flex items-center"
                            >
                  ...
                  {/* Documents Section */}
                  <div className="grid gap-3 grid-cols-2 border-t pt-4 border-black/5 mt-2 sm:col-span-2">
                    <FileUploadCard
            ...
            <section className="w-full rounded-2xl panel-luxury p-6 sm:p-8 shadow-luxury-md flex flex-col gap-6">
              ...
              {/* Show departure services */}
              {(form.trip_type === "one_way" || form.trip_type === "multi_city") && (
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span
                      className="text-xs font-extrabold uppercase tracking-widest text-teal-800"
                      style={pageMono}
                    >
            ...
            {validationWarning && (
              <div className="p-4 rounded-2xl bg-red-500/5 border border-red-500/10 flex items-start gap-3 animate-fadeIn">
                ...
                <div className="text-xs text-red-950 font-semibold leading-relaxed">
                  <span
                    className="block font-bold uppercase text-[9px] tracking-wider mb-0.5"
                    style={pageMono}
                  >
