                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button
                        type="button"
                        className="w-full h-12 rounded-xl border bg-white/60 px-4 text-xs font-semibold outline-none text-left flex items-center justify-between animate-fadeIn"
                        style={{ borderColor: creamTheme.line, color: creamTheme.ink }}
                      >
                ...
                <div className="flex flex-col gap-1 w-full">
                  ...
                  <div className="flex gap-2 mt-1 relative">
                    ...
                    <input
                      ...
                      className="flex-1 h-11 rounded-xl border bg-white/60 px-4 text-xs font-semibold outline-none transition-all focus:border-teal/50 animate-fadeIn"
                      style={{ borderColor: creamTheme.line, color: creamTheme.ink }}
                    />
                  </div>
