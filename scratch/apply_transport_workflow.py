...
export default function BookingView({ searchParams }: BookingViewProps) {
  ...
  const isTransportWorkflow = searchParams?.service_id === "transport";
  ...
  const getBasePrice = () => {
    let base = 12500;
    if (isTransportWorkflow || subServiceId === "transport") base = 14000;
  ...
  const transportStepConfigs = [
    {
      ...
      sub: "Specify pickup address, drop location, headcount, and transfer date.",
      estTime: "Est. 30 sec",
      progress: 33,
    },
    {
      title: "Passenger Contact & Review",
      sub: "Enter guest details and verify your transfer routing before booking.",
      estTime: "Est. 30 sec",
      progress: 66,
    },
    {
      title: "Transfer Reserved & Digital Pass",
      sub: "Your chauffeured Maybach sedan transfer is confirmed and assigned.",
      estTime: "Completed",
      progress: 100,
    },
  ];
  ...
  const activeConfigs = isTransportWorkflow
        ...
        >
          {isTransportWorkflow ? (
            ...
            <div className="space-y-6">
              {/* STEP 1: PICKUP, DROP & TRANSFER SCHEDULE */}
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    {/* Optional Flight Coordination Toggle */}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder="Excess luggage assistance, child seat requirement..."
                        className="w-full px-4 py-3.5 rounded-2xl bg-white border border-slate-200 text-slate-900 text-sm focus:outline-none focus:border-emerald-500 shadow-xs font-sans font-medium"
                      />
                    </div>
                  </div>
...
print("Rewrote BookingView.tsx with independent Chauffeur Transfer workflow.")
